// Central application + developer attribution metadata.
// Used across the Login footer, app footer, About page, exported reports and
// email notifications so the details live in exactly one place.
