  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover": "0 8px 24px -6px rgb(16 24 40 / 0.12), 0 2px 6px -2px rgb(16 24 40 / 0.06)",
        elevated: "0 12px 32px -8px rgb(16 24 40 / 0.16), 0 4px 10px -4px rgb(16 24 40 / 0.08)",
